...
contract BigBanana is ERC721URIStorage {

  /**
   * contract creator 就是root 用户
   */
  constructor() ERC721("BigBanana", "BBB") {
  ...
  // manager address, manager往往是给 中心化服务器使用的
  ...
  modifier shouldBeRoot(){
    ...
    require( rootAddress == msg.sender || managerAddress == msg.sender, message);
    _;
  }
   ...
   * 设置manager address
   */
  function setManager(address theManagerAddress) public {
    managerAddress = theManagerAddress;
  }
